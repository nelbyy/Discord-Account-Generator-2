...
def setProfile(token):
  ...
  changeprofile = httpx.patch('https://discord.com/api/v9/users/@me', headers=headers, json=data)
  print(changeprofile.text)

def register(serverinv=None):
    username = random_char(10)
    email = random_char(10) + random.choice(["@gmail.com", "@apple.com", "@outlook.com", "@microsoft.edu.com"])
    ...
    fingerprintres = httpx.get("https://discord.com/api/v9/experiments")
    ...
    try:
        ...
        print(f"Successfully generated account: {token}")
    except:
        pass
